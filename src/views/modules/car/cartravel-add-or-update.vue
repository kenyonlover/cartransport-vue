    ...
    >
      ...
      <el-col :span="8">
        <el-form-item label="净重" prop="netWeight" label-width="30%">
          ...
          <el-input-number :min="0" v-model="dataForm.netWeight" :precision="2" :step="0.01"></el-input-number>
        </el-form-item>
      </el-col>
      <!-- <el-col :span="8">
      ...
      <el-col :span="8">
        <el-form-item label="发货方净重" prop="deliveryNetWeight" label-width="30%">
          ...
          <el-input-number :min="0" v-model="dataForm.deliveryNetWeight" :precision="2" :step="0.01"></el-input-number>
        </el-form-item>
      </el-col>
      <!-- <el-col :span="8">
      ...
      <el-col :span="8">
        <el-form-item label="装车费/元" prop="loadingFee" label-width="30%">
          ...
          <el-input-number :min="0" v-model="dataForm.loadingFee" :precision="2" :step="0.01"></el-input-number>
        </el-form-item>
      </el-col>
      <el-col :span="8">
        <el-form-item label="过磅费/元" prop="weighingFee" label-width="30%">
          <!-- <el-input v-model="dataForm.weighingFee" placeholder="过磅费"></el-input> -->
          <el-input-number :min="0" v-model="dataForm.weighingFee" :precision="2" :step="0.01"></el-input-number>
        </el-form-item>
      </el-col>
      <el-col :span="8">
